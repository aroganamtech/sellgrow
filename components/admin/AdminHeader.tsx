...
export default function AdminHeader({
  ...
  return (
    <header className="sticky top-0 z-40 bg-white/90 dark:bg-[#070c14]/90 backdrop-blur-xl border-b border-slate-200 dark:border-slate-800/80 px-6 py-3.5 flex items-center justify-between shadow-sm transition-colors duration-300">
      <div className="flex items-center gap-3">
        {showBackHub && (
          <Link
            href={backHubHref}
            className="p-2 rounded-xl bg-slate-100 dark:bg-slate-800/80 text-slate-600 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white transition-colors"
