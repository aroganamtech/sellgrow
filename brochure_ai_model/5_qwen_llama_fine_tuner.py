...
class VisionModelFineTuner:
    ...
    def start_fine_tuning_simulation(self, dataset_path: str):
        ...
        print(f"🚀 Initializing Fine-Tuning Pipeline for Model: {self.model_name}")
        print(f"📊 Loading Fine-Tuning Dataset from: {dataset_path}")
        print(f"⚙️ Applying PEFT LoRA Adapters (r={self.lora_r}, alpha={self.lora_alpha})...")
        print("------------------------------------------------------------")
        ...
        print("------------------------------------------------------------")
        print(f"✅ Fine-Tuning Complete! Weights saved to ./checkpoints/brochure_ai_qwen2.5_lora")
