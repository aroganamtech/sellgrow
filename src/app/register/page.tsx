          ...
          <form onSubmit={handleSubmitRegistration} className="space-y-5">
                ...
                <div className="flex items-center gap-2 text-right">
                  {companyLogo ? (
                    <img
                      ...
                      className="w-8 h-8 rounded-lg object-cover border border-sky-400/50 shadow-md"
                    />
                  ) : (
            ...
            <div className="flex gap-3 pt-2">
              <button
                type="button"
                onClick={() => setStep(1)}
                className="w-1/3 py-3 border border-border bg-card hover:bg-muted text-foreground text-xs font-semibold rounded-xl transition-all"
              >
                ← Back
              </button>
              <button
                type="submit"
                disabled={isLoading}
                className="w-2/3 flex items-center justify-center gap-2 py-3 bg-gradient-to-r from-primary to-secondary text-white text-xs font-bold rounded-xl hover:opacity-95 disabled:opacity-50 transition-all shadow-md"
              >
                {isLoading ? (
                  <>
